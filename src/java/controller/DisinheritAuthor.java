 ...
 * @author Admin
 */
@WebServlet(name="DisinheritAuthor", urlPatterns={"/disinherit"})
public class DisinheritAuthor extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisinheritAuthor</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DisinheritAuthor at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(role.equals("2")){
            ...
            accDAO.disinheritAuthor(uid);
            
        }else{
            accDAO.changeRoleByUid(uid);
