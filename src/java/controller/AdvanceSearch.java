...
public class AdvanceSearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdvanceSearch</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdvanceSearch at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int numofchap = Integer.parseInt(request.getParameter("numofchap"));
        ...
        ArrayList<Books> blist = bDAO.loadBooksWithCondition(type, status, numofchap, sort);
        out.print("<div class=\"relative relative-content\">\n"
                + "                            <span class=\"page-title\">Kết quả tìm kiếm nâng cao</span>\n"
                + "                        </div>\n"
                + "                        <div class=\"items\">");
        for (Books b : blist) {
