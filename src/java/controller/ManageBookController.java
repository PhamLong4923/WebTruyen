 ...
 * @author Admin
 */
@WebServlet(name="ManageBookController", urlPatterns={"/managebook"})
public class ManageBookController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManageBookController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManageBookController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
       ...
       beAuthorDAO beaDAO = new beAuthorDAO();
        ...
        for (beAuthor bea : bealist) {
            out.print("<tr>\n"
                    ...
                    + "                                                    <td style=\"width: 15%\"><p><a href=\"#\" onclick=\"accept('"+bea.getUserId()+"')\">delete</a>/<a href=\"#\" onclick=\"denife('"+bea.getUserId()+"')\">Denife</a></p></td>\n"
                    + "                                                </tr>");
